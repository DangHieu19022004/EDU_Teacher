...
export default function StudentProfileScreen() {
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', paddingTop: 40, paddingHorizontal: 20 }}>
      ...
      {/* Info Fields */}
      {[
        { label: 'Họ tên', value: 'Nguyễn Văn A', icon: 'pencil', editable: true },
        { label: 'Giới tính', value: 'Nam', icon: 'chevron-down', editable: false },
        { label: 'Ngày sinh', value: '22/9/2005', icon: 'chevron-down', editable: false },
        { label: 'Trường học hiện tại', value: 'Nguyễn Trãi', icon: 'pencil', editable: true },
        { label: 'Số điện thoại', value: '0123456789', icon: 'pencil', editable: true }
      ].map((item, index) => (
        <View 
          key={index} 
          style={{
