          ...
          <TouchableWithoutFeedback onPress={() => {}}>
            <View className="h-1/6 bg-yellowwhite justify-center rounded-t-2xl p-5 border-t-2 border-l-2 border-r-2 border-yellowborder">
              <View className="flex-row space-x-4">
                <TouchableOpacity onPress={openCamera}  className="items-center mr-2 p-2 " activeOpacity={0.5}>
                  <Feather name="camera" size={30} color="black"/>
                  <Text className="mt-1">Camera</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={openGallery} className="items-center mr-2 p-2 " activeOpacity={0.5}>
                <AntDesign name="file1" size={30} color="black" />
                  <Text className="mt-1">Thiết bị</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => console.log('click')} className="items-center mr-2 p-2 " activeOpacity={0.5}>
